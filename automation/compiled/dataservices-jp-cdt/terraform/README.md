...
```commandline
compiled/dataservices-jp-cdt % tree .
.
├── scripts
│   ├── schematics.sh
...
Workspace name : dataservices-jp-cdt
...
Project subfolder compiled/dataservices-jp-cdt/terraform
