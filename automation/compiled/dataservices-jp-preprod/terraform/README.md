...
> Project :  dataservices-jp-preprod
> Environment :   preprod
> Region : jp-tok
...
### VPC Stack
    ...
    VPC with classic access enabled : jp-ds-vpc1   
    3 VSI on each zone in Region : jp-tok    
    3 Subnets     
    1 Jump Host
...
```commandline
compiled/dataservices-jp-preprod % tree .
.
├── scripts
│   ├── schematics.sh
...
Workspace name : dataservices-jp-preprod
...
Project subfolder compiled/dataservices-jp-preprod/terraform
