...
```commandline
compiled/dataservices-jp-prod % tree .
.
├── scripts
│   ├── schematics.sh
...
Workspace name : dataservices-jp-prod
...
Project subfolder compiled/dataservices-jp-prod/terraform
